...
import net.usecredits.credits.core.StoredBlock;
...
public interface BlockStore {
     ...
     * can be arbitrarily expensive, you probably should use {@link net.usecredits.credits.core.BlockChain#getChainHead()}
     * or perhaps {@link net.usecredits.credits.core.BlockChain#getBestChainHeight()} which will run in constant time and
