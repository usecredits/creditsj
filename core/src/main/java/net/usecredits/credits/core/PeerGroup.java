...
import net.usecredits.credits.core.Peer.PeerHandler;
import net.usecredits.credits.discovery.PeerDiscovery;
import net.usecredits.credits.discovery.PeerDiscoveryException;
...
public class PeerGroup extends AbstractIdleService {
     ...
     * peers. By using this with {@link net.usecredits.credits.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link net.usecredits.credits.core.PeerGroup#getMaxConnections()} returns is used.
     * @return
     */
    ...
    /**
     * See {@link net.usecredits.credits.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * times are available via {@link net.usecredits.credits.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link net.usecredits.credits.core.Peer#ping()}.
     */
