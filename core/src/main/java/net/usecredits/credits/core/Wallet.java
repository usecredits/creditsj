...
package net.usecredits.credits.core;

import net.usecredits.credits.crypto.KeyCrypterScrypt;
import org.litecoinj.wallet.Protos.Wallet.EncryptionType;
import org.spongycastle.crypto.params.KeyParameter;

import net.usecredits.credits.core.TransactionConfidence.ConfidenceType;
import net.usecredits.credits.core.WalletTransaction.Pool;
import net.usecredits.credits.crypto.KeyCrypter;
import net.usecredits.credits.crypto.KeyCrypterException;
import net.usecredits.credits.store.WalletProtobufSerializer;
import net.usecredits.credits.utils.Locks;
...
import static net.usecredits.credits.core.Utils.litecoinValueToFriendlyString;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, net.usecredits.credits.core.Wallet.AutosaveEventListener)}
...
public class Wallet implements Serializable, BlockChainListener {
     ...
     * followed by {@link Wallet#completeTx(net.usecredits.credits.core.Wallet.SendRequest)} and returning the requests
     ...
     * {@link Wallet#completeTx(net.usecredits.credits.core.Wallet.SendRequest)} to make it valid.
     *
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, net.usecredits.credits.core.Wallet.AutosaveEventListener)}
     ...
     * {@link net.usecredits.credits.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(net.usecredits.credits.crypto.KeyCrypter,
     ...
     * {@link net.usecredits.credits.crypto.KeyCrypterScrypt}.
     *
    ...
    /**
     * <p>Convenience wrapper around {@link Wallet#addNewEncryptedKey(net.usecredits.credits.crypto.KeyCrypter,
