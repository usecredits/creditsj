 ...
 * the lightweight SPV mode, a {@link net.usecredits.credits.store.BoundedOverheadBlockStore} may be a good choice.</p>
 *
 ...
 * {@link net.usecredits.credits.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to the
