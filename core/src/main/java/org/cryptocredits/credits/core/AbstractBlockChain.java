 ...
 * the lightweight SPV mode, a {@link org.cryptocredits.credits.store.BoundedOverheadBlockStore} may be a good choice.</p>
 *
 ...
 * {@link org.cryptocredits.credits.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to the
