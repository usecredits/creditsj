...
import org.cryptocredits.credits.core.Peer.PeerHandler;
import org.cryptocredits.credits.discovery.PeerDiscovery;
import org.cryptocredits.credits.discovery.PeerDiscoveryException;
...
public class PeerGroup extends AbstractIdleService {
     ...
     * peers. By using this with {@link org.cryptocredits.credits.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link org.cryptocredits.credits.core.PeerGroup#getMaxConnections()} returns is used.
     * @return
     */
    ...
    /**
     * See {@link org.cryptocredits.credits.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * times are available via {@link org.cryptocredits.credits.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link org.cryptocredits.credits.core.Peer#ping()}.
     */
