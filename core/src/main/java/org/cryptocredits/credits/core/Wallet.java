...
package org.cryptocredits.credits.core;

import org.cryptocredits.credits.crypto.KeyCrypterScrypt;
import org.litecoinj.wallet.Protos.Wallet.EncryptionType;
import org.spongycastle.crypto.params.KeyParameter;

import org.cryptocredits.credits.core.TransactionConfidence.ConfidenceType;
import org.cryptocredits.credits.core.WalletTransaction.Pool;
import org.cryptocredits.credits.crypto.KeyCrypter;
import org.cryptocredits.credits.crypto.KeyCrypterException;
import org.cryptocredits.credits.store.WalletProtobufSerializer;
import org.cryptocredits.credits.utils.Locks;
...
import static org.cryptocredits.credits.core.Utils.litecoinValueToFriendlyString;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.cryptocredits.credits.core.Wallet.AutosaveEventListener)}
...
public class Wallet implements Serializable, BlockChainListener {
     ...
     * followed by {@link Wallet#completeTx(org.cryptocredits.credits.core.Wallet.SendRequest)} and returning the requests
     ...
     * {@link Wallet#completeTx(org.cryptocredits.credits.core.Wallet.SendRequest)} to make it valid.
     *
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.cryptocredits.credits.core.Wallet.AutosaveEventListener)}
     ...
     * {@link org.cryptocredits.credits.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(org.cryptocredits.credits.crypto.KeyCrypter,
     ...
     * {@link org.cryptocredits.credits.crypto.KeyCrypterScrypt}.
     *
    ...
    /**
     * <p>Convenience wrapper around {@link Wallet#addNewEncryptedKey(org.cryptocredits.credits.crypto.KeyCrypter,
