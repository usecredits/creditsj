...
import org.cryptocredits.credits.store.BlockStore;
import org.cryptocredits.credits.store.BlockStoreException;
...
public class Peer {
  ...
  private void processMessage(MessageEvent e, Message m) throws IOException, VerificationException, ProtocolException {
     ...
     * Once the pong is received the value returned by {@link org.cryptocredits.credits.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link org.cryptocredits.credits.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link org.cryptocredits.credits.core.Peer#ping()} has never
